...
class EndpointConfigurationFactory implements EndpointConfigurationFactoryInterface
{
    ...
    public function expectSignedResponse(): EndpointConfigurationFactoryInterface
    {
        ...
        $this->headers[] =  [Constants::ACCEPT_HEADER,
            Constants::APPLICATION_JSON_JOSE_VALUE . ', ' . Constants::APPLICATION_PROBLEM_JSON_VALUE];
    ...
    public function expectPlainResponse(): EndpointConfigurationFactoryInterface
    {
        $this->signedResponse = false;
        $this->headers[] =  [Constants::ACCEPT_HEADER,
            Constants::APPLICATION_JSON_VALUE . ', ' . Constants::APPLICATION_PROBLEM_JSON_VALUE];
    ...
    public function signRequest(): EndpointConfigurationFactoryInterface
    {
        ...
        $this->headers[] = [Constants::CONTENT_TYPE_HEADER, Constants::APPLICATION_JSON_JOSE_VALUE];
    ...
    public function withCredentials(): EndpointConfigurationFactoryInterface
    {
        ...
        $this->headers[] = [Constants::CONTENT_TYPE_HEADER, Constants::APPLICATION_FORM_VALUE];

        return $this;
    }

    public function withHeaders(array $headers): EndpointConfigurationFactoryInterface
    {
    ...
    public function build(): EndpointConfigurationInterface
    {
        ...
        $configuration->setHeaders($this->headers);
