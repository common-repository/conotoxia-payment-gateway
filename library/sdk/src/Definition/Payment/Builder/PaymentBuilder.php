...
class PaymentBuilder implements PaymentBuilderInterface
{
     ...
     * @return PaymentBuilderInterface
     */
    public function setSelectedPaymentMethod(?SelectedPaymentMethodInterface $selectedPaymentMethod): PaymentBuilderInterface
    {
        $this->payment->setSelectedPaymentMethod($selectedPaymentMethod);
        return $this;
    }
     ...
     * @return PaymentBuilderInterface
     */
    public function buildSelectedPaymentMethod(callable $callable): PaymentBuilderInterface
    {
        $selectedPaymentMethod = new SelectedPaymentMethodBuilder();
        call_user_func($callable, $selectedPaymentMethod);
        $this->payment->setSelectedPaymentMethod($selectedPaymentMethod->getSelectedPaymentMethod());
        return $this;
    }
     ...
     */
    public function createSelectedPaymentMethodBuilder(): SelectedPaymentMethodBuilderInterface
    {
        return new SelectedPaymentMethodBuilder();
    }
     ...
     * @return PaymentBuilderInterface
     */
    public function setRetryEnabled(bool $retryEnabled): PaymentBuilderInterface
    {
        $this->payment->setRetryEnabled($retryEnabled);
     ...
     * @return PaymentBuilderInterface
     */
    public function setUserAcceptLanguage(?string $userAcceptLanguage): PaymentBuilderInterface
    {
        $this->payment->setUserAcceptLanguage($userAcceptLanguage);
